  ...
  return (
    <section className="relative bg-[#020617] pt-32 pb-20 sm:pt-40 sm:pb-24 overflow-hidden bg-bg-dark">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full max-w-7xl pointer-events-none">
        <div className="absolute top-20 left-1/4 w-[500px] h-[500px] bg-emerald-600/20 rounded-full blur-[100px] opacity-50 mix-blend-screen animate-pulse-slow"></div>
        <div className="absolute top-40 right-1/4 w-[400px] h-[400px] bg-emerald-500/20 rounded-full blur-[100px] opacity-50 mix-blend-screen animate-pulse-slow" style={{ animationDelay: '2s' }}></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
        <div className="text-center max-w-4xl mx-auto mb-16">
          ...
          bg-emerald-600 hover:bg-emerald-500 before:bg-gradient-to-b before:from-emerald-400 before:to-emerald-600 w-full sm:w-auto"
            ...
            <div className="p-6 grid grid-cols-1 md:grid-cols-3 gap-6 bg-[#0B1120]/95 backdrop-blur-sm">
              ...
              <div className="col-span-1 bg-slate-900/50 border border-slate-800 rounded-xl p-5">
                ...
                <div className="flex items-center justify-center h-40 relative">
                  ...
                  <div className="w-32 h-32 rounded-full border-[16px] border-emerald-500 border-r-teal-500 border-b-cyan-500 border-l-green-500 transform rotate-45"></div>
                  ...
                  {[...Array(35)].map((_, i) => (
                    <div
                      ...
                      className={`w-full pt-[100%] rounded-sm ${
                        ...
                        Math.random() > 0.4 ? 'bg-emerald-500/40' :
                        'bg-slate-800'
                      }`}
                    ></div>
                  ))}
                ...
                <div className="space-y-4 flex-1">
                  ...
                  <div className="bg-slate-800/50 rounded-lg p-3">
                    <div className="flex justify-between text-xs mb-1">
                      ...
                      <span className="text-teal-400">1.2GB</span>
                    </div>
                    <div className="w-full h-1.5 bg-slate-700 rounded-full overflow-hidden">
