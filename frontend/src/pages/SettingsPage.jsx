          ...
          <div className="bg-[#161b22] border border-[#30363d] rounded-xl p-6">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-[#0d1117] border border-[#30363d] rounded-lg px-4 py-3 text-gray-100 focus:outline-none focus:border-emerald-500/50 focus:ring-1 focus:ring-emerald-500/20 transition-all placeholder-gray-600"
                      />
                    </div>
                    <div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows={4}
                      maxLength={500}
                      className="w-full bg-[#0d1117] border border-[#30363d] rounded-lg px-4 py-3 text-gray-100 focus:outline-none focus:border-emerald-500/50 focus:ring-1 focus:ring-emerald-500/20 transition-all resize-none placeholder-gray-600"
                ...
                <div className="flex items-center gap-3 pt-6 border-t border-[#30363d]">
                  <button
                    ...
                    disabled={saving}
                    className="flex items-center gap-2 bg-emerald-600 hover:bg-emerald-500 disabled:bg-gray-700 disabled:text-gray-500 px-6 py-2.5 rounded-lg transition-all font-medium text-white text-sm"
                  >
            ...
            {activeSection === 'appearance' && (
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-gray-400 text-sm">Customize how the app looks for you</p>
                </div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      {['light', 'dark'].map((theme) => (
                        ...
                        >
                          {theme === 'light' && <Sun size={24} className={preferences.theme === theme ? 'text-emerald-400' : 'text-gray-400'} />}
                          {theme === 'dark' && <Moon size={24} className={preferences.theme === theme ? 'text-emerald-400' : 'text-gray-400'} />}
                          <span className={`text-sm font-medium capitalize ${preferences.theme === theme ? 'text-emerald-400' : 'text-gray-400'}`}>{theme}</span>
                        </button>
                      ))}
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full bg-[#0d1117] border border-[#30363d] rounded-lg px-4 py-3 text-gray-100 focus:outline-none focus:border-emerald-500/50 focus:ring-1 focus:ring-emerald-500/20 transition-all"
                    >
            ...
            {activeSection === 'billing' && (
              <div className="space-y-6">
                ...
                <div className="p-6 bg-gradient-to-r from-emerald-500/10 via-teal-500/10 to-cyan-500/10 border border-emerald-500/20 rounded-xl">
                  <div className="flex items-center justify-between mb-4">
                    <div>
                      ...
                      <p className="text-sm text-gray-400">Unlimited projects • 100 MB storage per project</p>
                    </div>
                    <span className="px-4 py-2 bg-emerald-600 text-white font-semibold rounded-lg text-sm">Active</span>
                  </div>
                  <button className="w-full bg-emerald-600 hover:bg-emerald-500 text-white font-medium py-3 rounded-lg transition-all text-sm">
                    Upgrade to Pro
                  </button>
                </div>
                ...
                <div>
                  ...
                  <div className="p-6 bg-[#0d1117] border border-[#30363d] rounded-xl text-center">
...
const ToggleOption = ({ title, description, checked, onChange }) => (
  <div className="flex items-center justify-between p-4 bg-[#0d1117] rounded-xl border border-[#30363d]">
    ...
    <label className="relative inline-block w-12 h-6 cursor-pointer">
      ...
      />
      <div className="w-full h-full bg-[#30363d] peer-checked:bg-emerald-600 rounded-full peer transition-colors"></div>
